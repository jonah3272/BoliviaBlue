    ...
    >
      ...
      <div className={`flex flex-col ${compact ? 'gap-3' : 'gap-4'} md:flex-row md:items-center`}>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-2 flex-shrink-0">
          <BinanceButton size="md" placement={placement} className="h-11 justify-center min-w-[9.5rem]">
            {language === 'es' ? 'Crear cuenta Binance' : 'Create Binance account'}
          </BinanceButton>
          <AirtmButton size="md" placement={placement} className="h-11 justify-center min-w-[9.5rem]">
          ...
          {showGuideLink && (
            <Link
              ...
              className="inline-flex items-center justify-center h-11 min-w-[9.5rem] px-5 text-sm font-bold rounded-lg border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-11 min-w-[9.5rem] px-5 text-sm font-bold rounded-lg bg-[#25D366]/10 text-[#128C7E] dark:text-[#25D366] border border-[#25D366]/40 hover:bg-[#25D366]/20 transition-colors"
          >
