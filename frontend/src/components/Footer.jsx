  ...
  const columns = [
    {
      ...
      links: [
        ...
        { path: es ? '/guia-dinero-bolivia' : '/bolivia-money-guide', label: es ? 'Guía viajeros' : 'Traveler guide' },
    ...
    },
    {
      ...
      links: [
        ...
        { path: '/euro-a-boliviano', label: es ? 'Euro blue' : 'Euro blue' },
        { path: '/peso-a-boliviano', label: es ? 'Peso colombiano' : 'Colombian peso' },
        { path: '/sol-a-boliviano', label: es ? 'Sol peruano' : 'Peruvian sol' },
        { path: '/peso-argentino-a-boliviano', label: es ? 'Peso argentino' : 'Argentine peso' },
        { path: '/peso-chileno-a-boliviano', label: es ? 'Peso chileno' : 'Chilean peso' },
