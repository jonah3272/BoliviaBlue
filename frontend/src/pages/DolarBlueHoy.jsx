    ...
    <div className="min-h-screen bg-brand-bg dark:bg-gray-900 transition-colors">
      <PageMeta
        title={language === 'es'
          ...
          : 'Blue Dollar Today - Current Blue Dollar Quote in Bolivia | Updated Every 15 Min'}
        description={language === 'es'
          ? 'Dólar blue hoy actualizado cada 15 minutos. Consulta la cotización actual del dólar blue en Bolivia hoy. Precio en tiempo real, gráficos históricos y análisis del mercado paralelo. Gratis y sin registro.'
          : 'Blue dollar today updated every 15 minutes. Check the current blue dollar quote in Bolivia today. Real-time price, historical charts and parallel market analysis. Free and no registration required.'}
        ...
        <div className="text-center mb-4">
          ...
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-1 sm:mb-2">
            {language === 'es' 
              ...
              : 'Blue Dollar Today - Current Quote'}
          </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                {language === 'es' 
                  ? <>El <strong>dólar blue hoy</strong> refleja el precio actual del dólar estadounidense en el mercado paralelo de Bolivia. Esta cotización se actualiza cada 15 minutos utilizando datos en tiempo real de Binance P2P, proporcionándote la información más precisa sobre el <strong>dólar blue hoy en Bolivia</strong>.</>
                  : <>The <strong>blue dollar today</strong> reflects the current price of the US dollar in Bolivia's parallel market. This quote is updated every 15 minutes using real-time data from Binance P2P, providing you with the most accurate information about the <strong>blue dollar today in Bolivia</strong>.</>}
              </p>
